...
/* harmony import */ var _FeedbackListEntry_vue__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./FeedbackListEntry.vue */ "./resources/js/src/app/components/item/singleitem/FeedbackListEntry.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    'feedback-list-entry': _FeedbackListEntry_vue__WEBPACK_IMPORTED_MODULE_8__["default"]
  },
  props: {
    feedback: Object,
    isReply: Boolean,
...
/* harmony import */ var _FeedbackForm_vue__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./FeedbackForm.vue */ "./resources/js/src/app/components/item/singleitem/FeedbackForm.vue");
/* harmony import */ var _FeedbackList_vue__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./FeedbackList.vue */ "./resources/js/src/app/components/item/singleitem/FeedbackList.vue");
/* harmony import */ var vuex__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! vuex */ "./node_modules/vuex/dist/vuex.esm.js");
/* harmony import */ var _mixins_loadFeedbackModule__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../mixins/loadFeedbackModule */ "./resources/js/src/app/mixins/loadFeedbackModule.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    'feedback-form': _FeedbackForm_vue__WEBPACK_IMPORTED_MODULE_8__["default"],
    'feedback-list': _FeedbackList_vue__WEBPACK_IMPORTED_MODULE_9__["default"]
  },
  mixins: [_mixins_loadFeedbackModule__WEBPACK_IMPORTED_MODULE_10__["default"]],
  inject: {
    itemId: {
      default: null
    }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    'feedback-comment': () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./FeedbackComment.vue */ "./resources/js/src/app/components/item/singleitem/FeedbackComment.vue"))
  },
  props: {
    feedback: Object,
    isReply: Boolean,
  ...
  computed: _objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_10__.mapState)({
    authenticatedUser: state => state.feedback.authenticatedUser
  })),
  methods: {
...
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c("div", [_vm.authenticatedUser.isLoggedIn || _vm.options.allowGuestFeedbacks ? _vm._ssrNode('<div class="createFeedback">', "</div>", [_vm._ssrNode('<div class="stars"><fieldset><legend><span class="d-none">' + _vm._ssrEscape(_vm._s(_vm.$translate("Feedback::Feedback.feedbackTextLegend"))) + "</span></legend> " + _vm._ssrList([5, 4, 3, 2, 1], function (i) {
    return "<input" + _vm._ssrAttr("id", "star-" + i + _vm._uid) + ' type="radio"' + _vm._ssrAttr("name", "ratingValue" + _vm._uid) + _vm._ssrAttr("value", i) + _vm._ssrAttr("checked", _vm._q(_vm.feedback.ratingValue, i)) + _vm._ssrClass(null, "star star-" + i) + "> <label" + _vm._ssrAttr("for", "star-" + i + _vm._uid) + _vm._ssrClass(null, "star star-" + i) + '><span class="d-none">' + _vm._ssrEscape(_vm._s(_vm.$translate("Feedback::Feedback.feedbackAverageLabel"))) + "</span></label>";
  }) + "</fieldset></div> " + (_vm.ratingMissing ? '<p class="feedback-error alert alert-danger">' + _vm._ssrEscape("\n      " + _vm._s(_vm.$translate("Feedback::Feedback.ratingRequired")) + "\n    ") + "</p>" : "<!---->") + " " + (!_vm.authenticatedUser.isLoggedIn && _vm.options.allowGuestFeedbacks ? '<div class="form-group"><input id="author" type="text" name="author"' + _vm._ssrAttr("placeholder", _vm.$translate("Feedback::Feedback.authorName")) + _vm._ssrAttr("disabled", _vm.authenticatedUser.limitReached || !_vm.authenticatedUser.hasPurchased) + _vm._ssrAttr("value", _vm.feedback.authorName) + ' class="form-control"> <label for="author" class="position-absolute"><span class="d-none">' + _vm._ssrEscape(_vm._s(_vm.$translate("Feedback::Feedback.authorName"))) + '</span></label> <input id="feedback-textfield" type="text" name="feedback-textfield"' + _vm._ssrAttr("value", _vm.feedback.honeypot) + ' class="form-control"> <label for="feedback-textfield" class="position-absolute"><span class="d-none">' + _vm._ssrEscape(_vm._s(_vm.$translate("Feedback::Feedback.feedbackTextLabel"))) + "</span></label></div>" : "<!---->") + ' <div class="form-group"><input id="title" type="text" name="title"' + _vm._ssrAttr("placeholder", _vm.$translate("Feedback::Feedback.title")) + _vm._ssrAttr("disabled", _vm.authenticatedUser.limitReached || !_vm.authenticatedUser.hasPurchased) + _vm._ssrAttr("value", _vm.feedback.title) + _vm._ssrClass("form-control", {
    "is-invalid": _vm.titleMissing
  }) + '> <label for="title" class="position-absolute"><span class="d-none">' + _vm._ssrEscape(_vm._s(_vm.$translate("Feedback::Feedback.title"))) + '</span></label> <div class="invalid-feedback">' + _vm._ssrEscape("\n        " + _vm._s(_vm.$translate("Feedback::Feedback.titleRequired")) + "\n      ") + '</div></div> <div class="form-group"><textarea id="message" name="message" rows="3"' + _vm._ssrAttr("placeholder", _vm.$translate("Feedback::Feedback.reviewMessage")) + _vm._ssrAttr("disabled", _vm.authenticatedUser.limitReached || !_vm.authenticatedUser.hasPurchased) + ' class="form-control">' + _vm._ssrEscape(_vm._s(_vm.feedback.message)) + '</textarea> <label for="message" class="position-absolute"><span class="d-none">' + _vm._ssrEscape(_vm._s(_vm.$translate("Feedback::Feedback.reviewMessage"))) + "</span></label></div> "), _vm.authenticatedUser.limitReached ? _c("div", {
    directives: [{
      name: "tooltip",
      rawName: "v-tooltip"
    }],
...
var render = function render() {
  ...
  }, [!_vm.editableFeedback && _vm.showControls || _vm.isFeedbackEditable(_vm.feedbackData.id) || _vm.canUserEdit() ? _vm._ssrNode('<div class="feedback-options">', "</div>", [!_vm.feedbackData.isVisible ? _c("span", {
    directives: [{
      name: "tooltip",
      rawName: "v-tooltip"
    }],
...
var render = function render() {
  ...
  return _c("section", {
    ...
    attrs: {
      ...
      "show-empty-ratings": _vm.options.showEmptyRatingsInOrderConfirmation === "true"
    }
  }) : _vm._e()], 2);
};
var staticRenderFns = [];
...
var render = function render() {
  ...
  }, [_vm._ssrNode('<div class="stars"><form><fieldset class="d-flex flex-row-reverse"><legend><span class="d-none">' + _vm._ssrEscape(_vm._s(_vm.item.name)) + "</span></legend> " + _vm._ssrList(_vm.starIds, function (starId) {
  ...
  }) + "</fieldset></form></div> <a" + _vm._ssrAttr("href", _vm.item.url) + "><img" + _vm._ssrAttr("alt", "image " + _vm.item.name) + _vm._ssrAttr("src", _vm.item.image) + ' class="py-2"> <span class="feedback-item-title">' + _vm._ssrEscape(_vm._s(_vm.item.name)) + '</span></a> <div class="feedback-item-link">' + _vm._ssrList(_vm.item.attributes, function (attribute) {
...
/* harmony import */ var _app_store_FeedbackModule__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./app/store/FeedbackModule */ "./resources/js/src/app/store/FeedbackModule.js");




function beforeCreate(context) {
  Vue.component('FeedbackAverage', () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./app/components/item/FeedbackAverage.vue */ "./resources/js/src/app/components/item/FeedbackAverage.vue")));
  Vue.component('FeedbackContainer', () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./app/components/item/singleitem/FeedbackContainer.vue */ "./resources/js/src/app/components/item/singleitem/FeedbackContainer.vue")));
  Vue.component('FeedbackOrderContainer', () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./app/components/order/FeedbackOrder.vue */ "./resources/js/src/app/components/order/FeedbackOrder.vue")));
}
function beforeRender(vueApp) {
  vueApp.$store.registerModule('feedback', _app_store_FeedbackModule__WEBPACK_IMPORTED_MODULE_3__["default"]);
}
