...
var render = function render() {
  ...
  return _c("div", {
    ...
    attrs: {
      id: "feedbackConfirmDeleteLabel-" + _vm.id
    }
    ...
    attrs: {
      src: _vm.item.image,
      alt: "image " + _vm.item.name
    }
  })]), _vm._v(" "), _c("fieldset", [_c("div", {
    staticClass: "stars"
  }, [_c("legend", [_c("span", {
    staticClass: "d-none"
  }, [_vm._v(_vm._s(_vm.$translate("Feedback::Feedback.customerReviews")))])]), _vm._v(" "), _vm._l(_vm.starIds, function (starId) {
    return [_c("input", {
      directives: [{
        name: "model",
        rawName: "v-model",
      ...
      staticClass: "d-none"
    }, [_vm._v(_vm._s(starId.id))]), _vm._v(" "), _c("svg", {
      class: starId.class,
      staticStyle: {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "d-none"
  }, [_vm._v(_vm._s(_vm.item.name))])]), _vm._v(" "), _vm._l(_vm.starIds, function (starId) {
    return [_c("input", {
      directives: [{
        name: "model",
        rawName: "v-model",
    ...
    staticClass: "feedback-item-title"
